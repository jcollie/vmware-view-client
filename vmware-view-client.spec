...
rm -rf %{buildroot}
mkdir -p %{buildroot}
tar --extract --directory %{buildroot} --strip-components=1 --file %{S:0}

mv %{buildroot}/%{_bindir}/vmware-view %{buildroot}/%{_libdir}/vmware/vmware-view
mv %{buildroot}/%{_libdir}/vmware/vmware-view-usbd %{buildroot}/%{_libdir}/vmware/vmware-view-usb

cp -a %{S:1} %{buildroot}/%{_bindir}/vmware-view
